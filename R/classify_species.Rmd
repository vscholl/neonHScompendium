...
```{r ntree_tuning_results, eval=FALSE}
...
Single figure with both variable importance plots: 

```{r varmImp_species}
library(ggpubr)

ggpubr::ggarrange(varImp_MDA_species, varImp_Gini_species, nrow = 2)
 
# save confusion matrix to file 
#ggsave(filename = here::here("analysis","figures", "varImp_species.pdf"), width = 10, height = 10)
```
