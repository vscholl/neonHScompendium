...
Proposing to update the PFTs based on the MODIS land cover types: Evergreen Needleleaf
Forests, Evergreen Broadleaf Forests, Deciduous Needleleaf Forests, Deciduous Broadleaf
Forests, Shrub. 
...
- common name
- PFT (based on Macrosystems labels)
- seasonality (evergreen or deciduous)
- leaf type (broadleaf or needleleaf)
- growth form (shrub or forest)
...
for(i in 1:nrow(taxon_pft_lookup)){
  ...
  if(genusSpecies == "Abies amabilis"){
    ...
    taxon_pft_lookup$seasonality[i] = "evergreen"
    taxon_pft_lookup$leafType[i] = "needleleaf"
    taxon_pft_lookup$growthForm[i] = "forest"
    ...
    taxon_pft_lookup$seasonality[i] = "deciduous"
    ...
    taxon_pft_lookup$pft[i] = "???" # is not deciduous or coniferous forest
    taxon_pft_lookup$seasonality[i] = "evergreen"
    taxon_pft_lookup$leafType[i] = "broadleaf"
    taxon_pft_lookup$growthForm[i] = "forest"
    ...
    taxon_pft_lookup$seasonality[i] = ""
    taxon_pft_lookup$leafType[i] = ""
    taxon_pft_lookup$growthForm[i] = "forest"
