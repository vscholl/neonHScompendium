...
for(i in 1:nrow(taxon_pft_lookup)){
  ...
  if(genusSpecies == "Abies amabilis"){
    ...
    taxon_pft_lookup$pft_MRA[i] = "???" # is not deciduous or coniferous forest
    taxon_pft_lookup$phenology[i] = "evergreen"
    taxon_pft_lookup$leafType[i] = "broadleaf"
    taxon_pft_lookup$growthForm[i] = "tree"
    ...
    taxon_pft_lookup$pft_MRA[i] = "???"  # not deciduous or coniferous
    taxon_pft_lookup$phenology[i] = "evergreen"
    taxon_pft_lookup$leafType[i] = "broadleaf"
    taxon_pft_lookup$growthForm[i] = "tree"
    ...
    taxon_pft_lookup$pft_MRA[i] = "???"       # ???   # broadleaf evergreen tree
    taxon_pft_lookup$phenology[i] = ""
    taxon_pft_lookup$leafType[i] = ""
    taxon_pft_lookup$growthForm[i] = ""
    ...
    taxon_pft_lookup$pft_MRA[i] = "???"    # Growth Form - Multiple Stem, Height, Mature - 30ft
    ...
    taxon_pft_lookup$pft_MRA[i] = "???"   # shrub or tree ranging from 4 to 6m tall
    taxon_pft_lookup$commonName[i] = "honey mesquite"}
  
  else if(genusSpecies == "Prosopis velutina"){
    taxon_pft_lookup$pft_MRA[i] = "???" # deciduous shrub or tree is less than 15 m
    taxon_pft_lookup$commonName[i] = "velvet mesquite"}
  
  else if(genusSpecies == "Prunus americana"){
    taxon_pft_lookup$pft_MRA[i] = "???" # deciduous large shrub or small tree, reaching heights up to 15 feet
    ...
    taxon_pft_lookup$pft_MRA[i] = "???"  # apparently there are evergreen oak species? 
    ...
    taxon_pft_lookup$pft_MRA[i] = "???"     #  spreading shrub or small tree reaching 25 to 30 feet
    ...
    taxon_pft_lookup$pft_MRA[i] = "???" # deciduous multi-trunked tall shrub or medium-sized tree to 48ft or more
    taxon_pft_lookup$commonName[i] = "gum bully"}
  
  else if(genusSpecies == "Symplocos sp."){
    taxon_pft_lookup$pft_MRA[i] = "???"  # "deciduous or evergreen shrub or tree"
