...
for(i in 1:nrow(taxon_pft_lookup)){
  ...
  if(genusSpecies == "Abies amabilis"){
    ...
    taxon_pft_lookup$leafType[i] = "NA"
    ...
    taxon_pft_lookup$pft_MRA[i] = "NA"  # taxon class is too broad to specify 
    ...
    taxon_pft_lookup$phenology[i] = "evergreen"
    taxon_pft_lookup$leafType[i] = "needleleaf" # scale-like needle leaves
    taxon_pft_lookup$growthForm[i] = "tree"
    ...
    taxon_pft_lookup$phenology[i] = "deciduous" # larch is an unusual genus with deciduous conifers
    taxon_pft_lookup$leafType[i] = "needleleaf"
    taxon_pft_lookup$growthForm[i] = "tree"
    ...
    taxon_pft_lookup$pft_MRA[i] = "deciduous_forest"   # small deciduous tree or large shrub
    taxon_pft_lookup$pft_MODIS[i] = ""
    taxon_pft_lookup$phenology[i] = ""
    taxon_pft_lookup$leafType[i] = ""
    taxon_pft_lookup$growthForm[i] = ""
    ...
    taxon_pft_lookup$pft_MRA[i] = "woody_shrub"      # evergreen shrub
    taxon_pft_lookup$pft_MODIS[i] = ""
    taxon_pft_lookup$phenology[i] = ""
    taxon_pft_lookup$leafType[i] = ""
    taxon_pft_lookup$growthForm[i] = ""
    ...
    taxon_pft_lookup$pft_MRA[i] = "NA"       # ???   # broadleaf evergreen tree
    taxon_pft_lookup$pft_MODIS[i] = ""
    taxon_pft_lookup$phenology[i] = ""
    taxon_pft_lookup$leafType[i] = ""
    taxon_pft_lookup$growthForm[i] = ""
    ...
    taxon_pft_lookup$pft_MRA[i] = "NA"    # Growth Form - Multiple Stem, Height, Mature - 30ft
    ...
    taxon_pft_lookup$pft_MRA[i] = "NA"   # shrub or tree ranging from 4 to 6m tall
    taxon_pft_lookup$commonName[i] = "honey mesquite"}
  
  else if(genusSpecies == "Prosopis velutina"){
    taxon_pft_lookup$pft_MRA[i] = "NA" # deciduous shrub or tree is less than 15 m
    taxon_pft_lookup$commonName[i] = "velvet mesquite"}
  
  else if(genusSpecies == "Prunus americana"){
    taxon_pft_lookup$pft_MRA[i] = "NA" # deciduous large shrub or small tree, reaching heights up to 15 feet
    taxon_pft_lookup$commonName[i] = "American plum"}
  
  else if(genusSpecies == "Prunus angustifolia"){
    taxon_pft_lookup$pft_MRA[i] = "woody_shrub" # short, thickly branched shrub 3 to 10ft tall
