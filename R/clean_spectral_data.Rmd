...
```{r, eval = FALSE, include = "FALSE", warning=FALSE, fig.height=8, fig.width=10}
filtered_spectra %>%
  ggplot(aes(wavelength_nm, ifelse(mask, NA, reflectance), group = spectraID)) +
...
# save figure to file
ggsave(filename = here::here("analysis","figures", "spectra_per_species.pdf"), width = 10, height = 8)
```
