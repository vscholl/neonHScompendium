...
all_spectra %>% 
  dplyr::filter(spectraID %in% c(#"NEON.PLA.D20.PUUM.00954_2019",
                                 "NEON.PLA.D10.RMNP.04210_2018", 
                                 "NEON.PLA.D03.DSNY.00878_2018",
                                 "NEON.PLA.D01.BART.03618_2017")) %>%
  ggplot(aes(x = wavelength_nm, y = reflectance, group = spectraID)) +
  geom_line(aes(color = spectraID), 
            alpha = 0.5, size = 1) +
...
# save figure to file
ggsave(filename = here::here("analysis","figures", "hist_samples_per_species.pdf"), width = 10, height = 12)
```
