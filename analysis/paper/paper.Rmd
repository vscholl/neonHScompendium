...
Although the demand for species mapping is justified in many cases, there is also potential for both using and finding value in classifying individuals at other taxonomic levels, as explored in a recent bioacoustics study [@cramer2020chirping] and plant functional type mapping work in the High Arctic [@thomson2021multiscale]. 
In the plant realm, identifying taxa at the genus level had been shown to be easier than at the species level [@tuominen2018assessment].
