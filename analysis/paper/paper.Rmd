...
From the initial collection of 146 species, 50 species had at least 20 samples (Figure \@ref(fig:fig-histSpecies)). 
...
```{r fig-histSpecies, fig.cap ="Histogram: spectra count per species", echo=FALSE,  out.width = "450px", message = FALSE, warning=FALSE}
library(here)
