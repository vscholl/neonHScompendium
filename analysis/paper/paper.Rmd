...
Hyperspectral data are capable of capturing reflectance variations and features with hundreds of spectral bands better than multispectral remotely sensed data with a handful to tens of bands [@awad2018forest; @maschler2018individual].
...
RF is a machine learning approach that utilizes an ensemble of decision trees and iterative subsets of the training data [@breiman2001random].
