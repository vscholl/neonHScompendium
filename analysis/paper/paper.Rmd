...
In June 2020, we extracted hyperspectral data for all mapped stems at NEON sites that had an AOP flyover during the same year as when *in-situ* measurements were collected. 
This included 5972 observations of individual plants. Some individuals had multiple observations across years. 
