...
Variable importance for species classification (Figure \@ref(fig:fig-varImpSpecies))
...
```{r fig-varImpSpecies, fig.cap ="Variable importance for species classification", echo=FALSE,  out.width = "450px", message = FALSE, warning=FALSE}
library(here)
