...
1 - motivation for work, why bother?
...
Extracted hyperspectral data for all mapped stems at NEON sites
Figure \@ref(fig:fig_spectraExtracted)
Assumed plant locations don't change over time 
...
Packages neonUtilities, geoNEON, neonhs (cite)
...
```{r fig_studyArea, fig.cap = "Map of the NEON sampling locations and domains with data that we used in this study.", echo=FALSE,  out.width = "450px", message = FALSE, warning=FALSE}
library(here)
...
```{r fig_honestWork, fig.cap = "", echo=FALSE,  out.width = "450px", message = FALSE, warning=FALSE}
...
```{r fig_spectraExtracted, fig.cap = "", echo=FALSE,  out.width = "450px", message = FALSE, warning=FALSE}
library(here)
